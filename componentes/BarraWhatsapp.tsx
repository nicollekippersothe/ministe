    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-borda bg-fundo/92 backdrop-blur-sm">
      ...
      >
        <a
          ...
          className="flex h-13 w-full items-center justify-center gap-2.5 rounded-full bg-zap px-5 text-[1.02rem] font-semibold text-white shadow-[0_2px_12px_rgba(14,122,85,0.28)] transition-colors hover:bg-zap-forte active:bg-zap-forte"
        >
