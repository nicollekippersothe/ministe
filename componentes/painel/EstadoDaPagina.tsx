...
/**
 * O endereço da página, e quem consegue abrir esse endereço.
 *
 ...
 *    diz melhor.
 *
 * **O que entrou no lugar.** O endereço é o assunto, então é ele que aparece
 ...
 * próprio endereço: com a página no ar ele é link, sublinhado e com a seta de
 * abrir; guardada, ele é texto. Vale mais que uma convenção de cor porque é o
 * que acontece de verdade quando alguém toca ali.
 *
 ...
 * quem enxerga o endereço. Ela faz par direto com "No ar", e as duas respondem
  ...
  return (
    <div>
      ...
      >
        ...
        .{" "}
        {noAr
          ? "Qualquer pessoa que abrir este endereço vê a sua página."
          : "Publicar abre este endereço para qualquer pessoa."}
        {/*
