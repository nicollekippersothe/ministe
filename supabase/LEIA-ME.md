...
**Aplicadas no projeto de verdade:** o schema, e as correções 001 a 012, com a
bateria terminando em 164 asserções depois da última passada.
...
| `013-enderecos-dos-exemplos-novos.sql` | os seis endereços das páginas de exemplo novas entram na lista de reservados |
