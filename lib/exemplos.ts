...
export const astrologia: Negocio = {
  ...
  galeria: [
    ...
    foto("astro-g2.jpg", "Bolha congelada coberta de cristais de gelo, sobre fundo escuro"),
...
export const tatuagem: Negocio = {
  ...
  capa: capa("tatu-capa.jpg", "Braços fechados de tatuagem, em campo aberto na luz do fim de tarde"),
  fonte: "moderno",
  plano: "pago" as const,
  ...
  itens: [
    item(
      ...
      null,
      [foto("tatu-1.jpg", "Raposa geométrica em traço fino, tatuada na coxa")],
    ),
    item(
      "blackwork",
      "Blackwork autoral",
      ...
      null,
      [foto("tatu-2.jpg", "Costas e ombro fechados em blackwork geométrico, em preto e branco")],
    ),
    item(
      "cobertura",
      ...
      null,
      [foto("tatu-3.jpg", "Antebraço tatuado sobre a mesa, com um ramo em traço fino na mão")],
    ),
    item(
      "flash-day",
      "Flash day",
      ...
      null,
      [foto("tatu-4.jpg", "Caneta de bico apoiada numa folha de letras desenhadas à mão")],
    ),
  ],
  galeria: [
    foto("tatu-g1.jpg", "Duas mãos lado a lado, uma com letras tatuadas nos dedos"),
    foto("tatu-g2.jpg", "Vidro de tinta de desenho, caneta de bico e uma carta escrita à mão"),
    foto("tatu-g3.jpg", "Fio de tinta rosada se abrindo dentro da água"),
    foto("tatu-g4.jpg", "Braço estendido diante de uma parede branca, com o mapa-múndi tatuado"),
    foto("tatu-g5.jpg", "Dois antebraços cruzados, um com um sol e o outro com uma lua"),
    foto("tatu-g6.jpg", "Flores em traço fino na nuca, em preto e branco"),
  ],
  links: [
    { id: "insta", rotulo: "Instagram", url: "https://instagram.com/", icone: "instagram" },
    {
